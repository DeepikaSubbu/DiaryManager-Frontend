...
export default function Login({setIsLogin}){
    ...
    const registerSubmit = async e =>{
        e.preventDefault()
        try{
            const res = await axios.post('https://dairymanager-backend.herokuapp.com/users/register', {
                username: user.name,
                email:user.email,
 ...
 const loginSubmit = async e =>{
    ...
    e.preventDefault()
        try{
            const res = await axios.post('https://dairymanager-backend.herokuapp.com/users/login', {
